...
{
    public partial class C_Pant_Gen : Form
    {
        string aa_tabla = "";
        string aa_titulo = "";
        string aa_modo = "c";
        public string Id = "";
        public string aa_Descr = "";
        string aa_query = "";
        string aa_Campo_id = "";
        ...
        public C_Pant_Gen(string ii_modo, string ii_tabla, string ii_titulo)
        {
            InitializeComponent();
        ...
        private void DG_DATOS_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                if (aa_modo.ToUpper() == "E")
                {
                    ...
                    aa_Descr = DG_DATOS.Rows[i].Cells[1].Value.ToString().Trim();
