...
{
    public partial class Pant_Gen : Form
    {
        string aa_modo = "";
        string aa_tabla = "";
        string aa_titulo = "";
        ...
        public Pant_Gen(string ii_modo, string ii_tabla, string ii_titulo)
        {
            InitializeComponent();
            aa_modo = ii_modo;
            aa_tabla = ii_tabla;
        ...
        private void Pant_Gen_Load(object sender, EventArgs e)
        {
        ...
        private void BGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                DataSet ds = funciones.EjecutaSQL("SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = '" + aa_tabla + "' ORDER BY ORDINAL_POSITION", ref Error);
